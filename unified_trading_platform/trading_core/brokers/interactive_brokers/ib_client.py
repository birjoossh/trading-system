...
try:
    ...
    from ibapi.common import BarData, OrderId, MarketDataTypeEnum
    ...
    def securityDefinitionOptionParameter(self, reqId: int, exchange: str, underlyingConId: int, 
        ...
        try:
            ...
            if underlying_contract.exchange != "" and underlying_contract.exchange != exchange:
                return
            logger.info( "Received option params (exchange=%s, tradingClass=%s, expirations=%d, strikes=%d)",
                exchange, tradingClass, len(expirations), len(strikes))
