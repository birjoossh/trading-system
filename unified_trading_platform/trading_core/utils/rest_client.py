...
class RESTClient:
    ...
    def __init__(
        ...
        # Default headers
        self.session.headers.update({"Content-Type": "application/json", "User-Agent": "TradingSystem/1.0"})
    ...
    def _make_request(self, method: str, url: str, **kwargs) -> RESTResponse:
        ...
        try:
            ...
            response_time = time.time() - start_time
            return RESTResponse(
                status_code=0, data=None, headers={}, success=False, error_message=str(e), response_time=response_time
            )
    ...
    def delete(self, url: str, headers: Optional[Dict[str, str]] = None, **kwargs) -> RESTResponse:
        """Make DELETE request"""
