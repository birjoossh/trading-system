...
class AccountSummary:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'net_liquidation_value': float(self.net_liquidation_value),
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'AccountSummary':
        ...
        return cls(
            ...
            net_liquidation_value=Decimal(str(data['net_liquidation_value'])),
            total_cash_value=Decimal(str(data['total_cash_value'])),
            settled_cash=Decimal(str(data['settled_cash'])),
            ...
            look_ahead_next_change=datetime.fromisoformat(data['look_ahead_next_change']) if data.get('look_ahead_next_change') else None,
