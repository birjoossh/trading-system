...
def get_historical_market_data(broker, contract):
    ...
    hist_data: List[TickData] = broker.get_historical_data(
        contract=contract, duration="5 D", bar_size="1 hour", what_to_show="TRADES"
    )
    return hist_data
...
def main():
    ...
    try:
        ...
        spy_underlying = Contract(
            symbol="SPY", security_type=SecurityType.STOCK, exchange="NASDAQOM", currency="USD", conId=756733
        )
